    ...
    <main className='max-w-7xl mx-auto px-6 py-4 h-[900px]'>
      <section className='grid gap-12 justify-end'>
        <div className='pt-8 flex gap-4'>
          <h1 className='font-mont leading-[80px] text-[60px] text-white [text-shadow:_1px_3px_5px_rgb(0_0_0_/_100%)] pt-20 text-right w-full cursor-pointer hover:scale-125 ease-in-out duration-1000'>Don&apos;t let copycats hijack <br /> your brand&apos;s identity</h1>
        ...
        <div className="flex flex-col items-end text-white [text-shadow:_1px_3px_5px_rgb(0_0_0_/_100%)]">
          <div className="p-2 font-mont text-[20px] flex items-center rounded-full w-fit">{/*  bg-white/60 shadow-[0_0_8px_8px_rgba(255,255,255,0.6)] */}
            ...
            <div className="badge-container text-[30px] inline-block overflow-y-clip w-[250px] px-3 py-6 h-[32px] mx-2 bg-red-500/90 text-blue-100 rounded-xl relative  hover:shadow-[0px_0px_3px_3px_#333] hover:scale-150 transition-all ease-in-out duration-1000 cursor-pointer">{/*  shadow-[0_0_8px_8px_#ccc] */}
              <style jsx>{`
                  div.badge-content {
