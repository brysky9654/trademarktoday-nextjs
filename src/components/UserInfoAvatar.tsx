...
const UserInfoAvatar = ({ user }: { user: User }) => {
    ...
    return (
        <div className='user-info-wrap flex flex-col gap-2 justify-center items-center absolute top-4 right-2 cursor-pointer'>
            <style jsx>{`div.user-info-wrap:hover div.user-info { height:160px; }`}</style>
            ...
            <div className="user-info  h-0 w-52  shadow-[1px_1px_4px_#00000040] transition-all ease-in-out overflow-hidden bg-[#fefefe] rounded-lg">
